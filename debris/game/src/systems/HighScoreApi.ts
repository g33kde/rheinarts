/**
 * Client for Debris's global top-10 high score leaderboard
 * (`debris/highscore-api`, the first backend service in Rhein Arts).
 * Same-origin `/api/debris/highscores` - nginx proxies it in production
